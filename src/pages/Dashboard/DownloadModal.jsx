...
//   measurement = null,
//   bucket = import.meta.env.VITE_INFLUX_BUCKET,
//   fields = ["temperature", "odor", "humidity", "NH3", "H2S"],
// }) {
//    const pakistanOffset = 5; // UTC+5
...
//   // initialize single day and current date in Pakistan time
// const now = new Date();
// const utc = now.getTime() + now.getTimezoneOffset() * 60000;
// const pakTime = new Date(utc + pakistanOffset * 60 * 60 * 1000);

// const [singleDay, setSingleDay] = useState(true);
// const [startDate, setStartDate] = useState(dayjs(pakTime));
// const [endDate, setEndDate] = useState(dayjs(pakTime));
